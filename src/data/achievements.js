// Verified Hackathon Honors and Accredited Achievements

export const ACHIEVEMENTS = [
  {
    id: '01',
    edition: 'WIN 01',
    event: 'TechFiesta 2026',
    result: 'WINNER',
    resultBadge: '1ST PLACE // WINNER',
    domain: 'Agriculture',
    domainBadge: 'AGRICULTURE DOMAIN',
    project: 'KrishiSahAI',
  ...
  },
  {
    id: '02',
    edition: 'WIN 02',
    event: 'Pune Agri International Hackathon',
    result: 'RUNNER-UP',
    resultBadge: 'NATIONAL RUNNER-UP',
    domain: 'Precision AgriTech & Gov-Tech',
    domainBadge: 'AI GOVERNANCE & NDVI',
